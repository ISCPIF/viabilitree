...
//     }
//
//  override def findTrueLabel(t: NonEmptyTree[CONTENT], contentBuilder: (Point) => CONTENT)(implicit rng: Random): Option[NonEmptyTree[CONTENT]] = kdTreeComputation.findTrueLabel(t, contentBuilder)
//
...
//  }
//
//  def finished[T <: Label](t1: NonEmptyTree[T], t2: NonEmptyTree[T]) = t1.volume == t2.volume
//
//  def domain = zone
//
//}
