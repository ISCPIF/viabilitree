...
import scala.Some
import fr.iscpif.viability.kdtreeBounded.Interval
...
package object viabilityCabbage{
  ...
  //TODO: In the cabbage case the valid control does not depend on the state. I live this implementation if this changes
  def validControlInterval(state: State) = {
      new Interval(-timeStep, timeStep)
  }
