...
import fr.iscpif.viability.languages.LanguageModel._
...
package object viabilityLanguages {
  ...
  val dir = "../OutputKdTrees/languages"
  val maxDepth = 18
  ...
  def controlTestOrder(interval: Option[kdtree.Interval]): Array[Double] =
    interval match {
      case None => Array(0.0)
  ...
  /*generateTrajectory(perturbed, 0.0, last)(randomNG).foreach {
